...
| svc.rpc.backendConfig.sessionAffinity.affinityType | string | `"CLIENT_IP"` |  |
...
| svc.wss.backendConfig.sessionAffinity.affinityType | string | `"CLIENT_IP"` |  |
| svc.wss.backendConfig.timeoutSec | int | `400` |  |
| svc.wss.clustertype | string | `"ClusterIP"` |  |
| svc.wss.port | string | `"6061"` |  |
| svc_lb.clustertype | string | `"LoadBalancer"` |  |
| svc_lb.enabled | bool | `false` |  |
| svc_lb.hostname | string | `"integration.juno.prod"` |  |
| svc_lb.wss_hostname | string | `"integration-wss.juno.prod"` |  |
